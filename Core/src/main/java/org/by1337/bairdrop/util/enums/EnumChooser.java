package org.by1337.bairdrop.util.enums;
...
import org.by1337.bairdrop.util.SetValueCallBack;
...
public class EnumChooser<T extends Enum<T>> implements Listener {
    ...
    private final SetValueCallBack<Optional<T>> result;
    @Setter
     ...
     */
    public EnumChooser(Class<T> anEnum, EnumToItemStackConverter<T> converter, SetValueCallBack<Optional<T>> result) {
        this.result = result;
        this.converter = converter;
        this.anEnum = anEnum;
        this.inventory = Bukkit.createInventory(null, 54, OLDMessage.messageBuilder(lang.title));
    ...
    public void generate() {
        ...
        for (T val : anEnum.getEnumConstants()) {
            ...
            if (!im.hasDisplayName())
                im.setDisplayName(OLDMessage.messageBuilder(lang.clickToSelect));
