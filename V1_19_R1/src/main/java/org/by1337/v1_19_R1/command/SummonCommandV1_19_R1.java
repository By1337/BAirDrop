package org.by1337.v1_19_R1.command;
...
public class SummonCommandV1_19_R1 implements SummonCommand {
    @Override
        ...
        try {
            ...
            if (entity == null) {
                ...
                if (entity instanceof EntityInsentient) {
                    ((EntityInsentient) entity).a(world, world.d_(entity.db()), EnumMobSpawn.n,  null,  null);
                }
