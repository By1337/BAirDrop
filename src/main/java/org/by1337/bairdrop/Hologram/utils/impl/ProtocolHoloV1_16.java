...
public class ProtocolHoloV1_16 implements IProtocolHolo { //1.16.5-R0.1-SNAPSHOT
    ...
    public ProtocolHoloV1_16(List<String> lines, Location location) {
        this.lines = lines;
    ...
    private PacketContainer createMeta(int id, String name) {
        ...
        //remove marker
        watcher.setObject(new WrappedDataWatcher.WrappedDataWatcherObject(14, WrappedDataWatcher.Registry.get(Byte.class)), (byte) (0x01 | 0x08));
        ///
