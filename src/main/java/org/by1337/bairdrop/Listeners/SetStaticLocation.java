...
public class SetStaticLocation implements Listener {
    ...
    public void onClick(BlockBreakEvent e) {
        if (e.getPlayer().getInventory().contains(item)) {
            ...
            airDrop.save();
            Message.sendMsg(e.getPlayer(), Config.getMessage("set-static-loc"));
    ...
    public ItemStack getItem() {
        ...
        im.setDisplayName(Message.messageBuilder(Config.getMessage("item-name-set-static-loc")));
        lore.add(Message.messageBuilder(Config.getMessage("item-lore-set-static-loc")));
        im.setLore(lore);
